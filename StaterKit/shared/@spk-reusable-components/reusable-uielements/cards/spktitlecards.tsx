  ...
  return (
    <Fragment>
      <Card className={Customclass}>
        ...
        {Anchortagbefore ? <Link href={AnchortagNavigate} className="card-anchor"></Link> : ""}
        {Cardheader ?
          <Card.Header className={CustomHeaderclass}>
            <Card.Title>
              {Title}
            </Card.Title>
            {Linktag ? <Link href={Navigate} data-bs-toggle="card-remove" onClick={OnclickFunc} className={LinkClass}>
