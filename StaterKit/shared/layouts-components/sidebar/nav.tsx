...
export const MENUITEMS: any = [
...

  {
    title: "Dashboards", icon: Dashboardicon, type: "sub", active: false, children: [
      { path: "/components/dashboard/sales", type: "link", active: false, selected: false, title: "Home" },
    ]
  },
  {
    title: "Members", icon: Dashboardicon, type: "sub", active: false, children: [
      { path: "/members", type: "link", active: false, selected: false, title: "View Members" },
    ]
  },
...

  {
    icon: Erroricon, title: "Error", type: "sub", active: false, selected: false, children: [
      ...
      { path: "/components/authentication/error/401-error", type: "link", active: false, selected: false, title: "401-Error" },
    ]
  },
